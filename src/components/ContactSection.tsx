...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'thanmaireddy77@gmail.com',
    href: 'mailto:thanmaireddy77@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 96183 20150',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/919618320150',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/thanmaie-gopu-25b1b22a7',
    href: 'https://www.linkedin.com/in/thanmaie-gopu-25b1b22a7/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@thanmaireddy-dev',
    href: 'https://github.com/thanmaireddy-dev',
  },
];
